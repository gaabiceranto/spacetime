  ...
  return <div className="grid min-h-screen grid-cols-2">
    ...
    <div className='relative flex flex-col items-start justify-between px-28 py-16  overflow-hidden border-r border-white/10 bg-[url(../assets/bg-stars.svg)] bg-cover'>
     ...
     {/* Blur */}
      ...
      {/* Sign In */}
      <a href={`https://github.com/login/oauth/authorize?client_id=${process.env.NEXT_PUBLIC_GITHUB_CLIENT_ID}`} className='flex items-center gap-3 text-left hover:text-gray-50'>
      ...
      {/* Copyright */}
      <div className='text-sm leading-relaxed text-gray-200'>Feito com 💜 no NLW da {' '} <a target='_blank' rel='noreferrer' className='underline hover:text-gray-100' href="https://rocketseat.com.br">Rocketseat</a>
